...
let begin = true;
  ...
  function preload(){
    ...
    zeropic = loadImage("assets/Mossyfloorpic.png");
    onepic = loadImage("assets/Brickpic.png");
    twopic = loadImage("assets/Doorpic.png");
    threepic = loadImage("assets/Leftchestpic.png");
    fourpic = loadImage("assets/Openchestpic.png");
    fivepic = loadImage("assets/Rightchestpic.png");
    sixpic = loadImage("assets/Upchestpic.png");
    sevenpic = loadImage("assets/Downchestpic.png");
    eightpic = loadImage("assets/Finaldoorpic.png");
    ninepic = loadImage("assets/knight.jpg");
  }
  ...
  function displayGrid(){
    for(let y=0; y<gridSize; y++){
      for(let x=0; x<gridSize; x++){
        if(grid[y][x] === 0){
          image(zeropic, x*cellWidth, y*cellHeight, cellWidth, cellHeight);
        }
        if (grid[y][x] === 1){
          image(onepic, x*cellWidth, y*cellHeight, cellWidth, cellHeight);
        }
        if(grid[y][x] === 9){
          image(ninepic, x*cellWidth, y*cellHeight, cellWidth, cellHeight);
          }
        if(grid[y][x] === 2){
          image(twopic, x*cellWidth, y*cellHeight, cellWidth, cellHeight);
        }
        if(grid[y][x] === 3){
          image(threepic, x*cellWidth, y*cellHeight, cellWidth, cellHeight);
        }
        if(grid[y][x] === 4){
          image(fourpic, x*cellWidth, y*cellHeight, cellWidth, cellHeight);
        }
        if(grid[y][x] === 5){
          image(fivepic, x*cellWidth, y*cellHeight, cellWidth, cellHeight);
        }
        if(grid[y][x] === 6){
          image(sixpic, x*cellWidth, y*cellHeight, cellWidth, cellHeight);
        }
        if(grid[y][x] === 7){
          image(sevenpic, x*cellWidth, y*cellHeight, cellWidth, cellHeight);
    }
    if(grid[y][x] === 8){
      image(eightpic, x*cellWidth, y*cellHeight, cellWidth, cellHeight);
    }
    }
  }
}
